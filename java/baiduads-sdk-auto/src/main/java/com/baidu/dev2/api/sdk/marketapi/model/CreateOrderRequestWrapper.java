 ...
 */
@JsonPropertyOrder({
  CreateOrderRequestWrapper.JSON_PROPERTY_HEADER,
  CreateOrderRequestWrapper.JSON_PROPERTY_BODY
})
@JsonTypeName("CreateOrderRequestWrapper")
...
public class CreateOrderRequestWrapper {
  ...
  public CreateOrderRequestWrapper header(com.baidu.dev2.api.sdk.common.ApiRequestHeader header) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateOrderRequestWrapper createOrderRequestWrapper = (CreateOrderRequestWrapper) o;
    return Objects.equals(this.header, createOrderRequestWrapper.header) &&
        Objects.equals(this.body, createOrderRequestWrapper.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateOrderRequestWrapper {\n");
