 ...
 */
@JsonPropertyOrder({
  UpdateCampaignFeedResponseWrapper.JSON_PROPERTY_HEADER,
  UpdateCampaignFeedResponseWrapper.JSON_PROPERTY_BODY
})
@JsonTypeName("UpdateCampaignFeedResponseWrapper")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class UpdateCampaignFeedResponseWrapper {
  ...
  public UpdateCampaignFeedResponseWrapper header(com.baidu.dev2.api.sdk.common.ApiResponseHeader header) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateCampaignFeedResponseWrapper updateCampaignFeedResponseWrapper = (UpdateCampaignFeedResponseWrapper) o;
    return Objects.equals(this.header, updateCampaignFeedResponseWrapper.header) &&
        Objects.equals(this.body, updateCampaignFeedResponseWrapper.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCampaignFeedResponseWrapper {\n");
