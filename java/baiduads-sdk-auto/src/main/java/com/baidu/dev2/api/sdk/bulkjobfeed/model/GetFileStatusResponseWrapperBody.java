...
public class GetFileStatusResponseWrapperBody {
  ...
  private List<BulkJobStatusType> data = null;

  public GetFileStatusResponseWrapperBody() { 
  }

  public GetFileStatusResponseWrapperBody data(List<BulkJobStatusType> data) {
    
    this.data = data;
    return this;
  }

  public GetFileStatusResponseWrapperBody addDataItem(BulkJobStatusType dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<BulkJobStatusType> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(List<BulkJobStatusType> data) {
    this.data = data;
  }
