 ...
 */
@JsonPropertyOrder({
  UpdateAccountInfoResponseWrapper.JSON_PROPERTY_HEADER,
  UpdateAccountInfoResponseWrapper.JSON_PROPERTY_BODY
})
@JsonTypeName("UpdateAccountInfoResponseWrapper")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class UpdateAccountInfoResponseWrapper {
  ...
  public UpdateAccountInfoResponseWrapper header(com.baidu.dev2.api.sdk.common.ApiResponseHeader header) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateAccountInfoResponseWrapper updateAccountInfoResponseWrapper = (UpdateAccountInfoResponseWrapper) o;
    return Objects.equals(this.header, updateAccountInfoResponseWrapper.header) &&
        Objects.equals(this.body, updateAccountInfoResponseWrapper.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAccountInfoResponseWrapper {\n");
