 ...
 */
@JsonPropertyOrder({
  GetWordResponseWrapper.JSON_PROPERTY_HEADER,
  GetWordResponseWrapper.JSON_PROPERTY_BODY
})
@JsonTypeName("GetWordResponseWrapper")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class GetWordResponseWrapper {
  ...
  public GetWordResponseWrapper header(com.baidu.dev2.api.sdk.common.ApiResponseHeader header) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetWordResponseWrapper getWordResponseWrapper = (GetWordResponseWrapper) o;
    return Objects.equals(this.header, getWordResponseWrapper.header) &&
        Objects.equals(this.body, getWordResponseWrapper.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetWordResponseWrapper {\n");
