 ...
 */
@JsonPropertyOrder({
  AddAdgroupResponseWrapper.JSON_PROPERTY_HEADER,
  AddAdgroupResponseWrapper.JSON_PROPERTY_BODY
})
@JsonTypeName("AddAdgroupResponseWrapper")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class AddAdgroupResponseWrapper {
  ...
  public AddAdgroupResponseWrapper header(com.baidu.dev2.api.sdk.common.ApiResponseHeader header) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddAdgroupResponseWrapper addAdgroupResponseWrapper = (AddAdgroupResponseWrapper) o;
    return Objects.equals(this.header, addAdgroupResponseWrapper.header) &&
        Objects.equals(this.body, addAdgroupResponseWrapper.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddAdgroupResponseWrapper {\n");
