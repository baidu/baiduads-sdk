...
import com.baidu.dev2.api.sdk.businesspoint.model.*;
...
public class BusinessPointService {
   ...
   * 
   * 
   * @param getAllBusinessPointRequestWrapper  (required)
   * @return GetAllBusinessPointResponseWrapper
  ...
  public GetAllBusinessPointResponseWrapper getAllBusinessPoint(GetAllBusinessPointRequestWrapper getAllBusinessPointRequestWrapper) throws ApiException {
    Object localVarPostBody = getAllBusinessPointRequestWrapper;
    
    // verify the required parameter 'getAllBusinessPointRequestWrapper' is set
    if (getAllBusinessPointRequestWrapper == null) {
      throw new ApiException(400, "Missing the required parameter 'getAllBusinessPointRequestWrapper' when calling getAllBusinessPoint");
    }
    
    // create path and map variables
    String localVarPath = "/json/sms/service/BusinessPointService/getAllBusinessPoint";
