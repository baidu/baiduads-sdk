 ...
 */
@JsonPropertyOrder({
  BatchRequest.JSON_PROPERTY_ITEMS
})
...
public class BatchRequest {
  ...
  public BatchRequest items(List<Long> items) {
    
    this.items = items;
    return this;
  }

  public BatchRequest addItemsItem(Long itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, batchRequest.items);
  }
