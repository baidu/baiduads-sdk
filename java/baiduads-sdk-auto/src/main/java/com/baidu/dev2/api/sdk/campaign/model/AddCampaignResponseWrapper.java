 ...
 */
@JsonPropertyOrder({
  AddCampaignResponseWrapper.JSON_PROPERTY_HEADER,
  AddCampaignResponseWrapper.JSON_PROPERTY_BODY
})
@JsonTypeName("AddCampaignResponseWrapper")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class AddCampaignResponseWrapper {
  ...
  public AddCampaignResponseWrapper header(com.baidu.dev2.api.sdk.common.ApiResponseHeader header) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddCampaignResponseWrapper addCampaignResponseWrapper = (AddCampaignResponseWrapper) o;
    return Objects.equals(this.header, addCampaignResponseWrapper.header) &&
        Objects.equals(this.body, addCampaignResponseWrapper.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddCampaignResponseWrapper {\n");
