 ...
 */
@JsonPropertyOrder({
  AddSegmentRequestWrapper.JSON_PROPERTY_HEADER,
  AddSegmentRequestWrapper.JSON_PROPERTY_BODY
})
@JsonTypeName("AddSegmentRequestWrapper")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class AddSegmentRequestWrapper {
  ...
  public AddSegmentRequestWrapper header(com.baidu.dev2.api.sdk.common.ApiRequestHeader header) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddSegmentRequestWrapper addSegmentRequestWrapper = (AddSegmentRequestWrapper) o;
    return Objects.equals(this.header, addSegmentRequestWrapper.header) &&
        Objects.equals(this.body, addSegmentRequestWrapper.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddSegmentRequestWrapper {\n");
