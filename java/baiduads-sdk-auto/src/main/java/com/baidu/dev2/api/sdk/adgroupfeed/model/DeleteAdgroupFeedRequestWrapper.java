...
public class DeleteAdgroupFeedRequestWrapper {
  ...
  private DeleteAdgroupFeedRequestWrapperBody body;
  ...
  **/
  ...
  public DeleteAdgroupFeedRequestWrapper body(DeleteAdgroupFeedRequestWrapperBody body) {
  ...
  **/
  ...
  public DeleteAdgroupFeedRequestWrapperBody getBody() {
    return body;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BODY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBody(DeleteAdgroupFeedRequestWrapperBody body) {
    this.body = body;
  }
