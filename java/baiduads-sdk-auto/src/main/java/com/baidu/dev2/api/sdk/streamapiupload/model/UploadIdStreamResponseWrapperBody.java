...
import com.baidu.dev2.api.sdk.streamapiupload.model.StreamApiUploadResponse;
...
public class UploadIdStreamResponseWrapperBody {
  ...
  private List<StreamApiUploadResponse> data = null;

  public UploadIdStreamResponseWrapperBody() { 
  }

  public UploadIdStreamResponseWrapperBody data(List<StreamApiUploadResponse> data) {
    
    this.data = data;
    return this;
  }

  public UploadIdStreamResponseWrapperBody addDataItem(StreamApiUploadResponse dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<StreamApiUploadResponse> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(List<StreamApiUploadResponse> data) {
    this.data = data;
  }
