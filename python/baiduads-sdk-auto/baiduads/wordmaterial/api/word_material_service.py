...
class WordMaterialService(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.search_endpoint = _Endpoint(
            settings={
                'response_type': (SearchResponseWrapper,),
                'auth': [],
                'endpoint_path': '/json/sms/service/WordMaterialService/search',
                'operation_id': 'search',
                'http_method': 'POST',
                'servers': None,
            },
    ...
    def search(
        ...
        **kwargs
        ...
        >>> thread = api.search(search_request_wrapper, async_req=True)
        >>> result = thread.get()
