...
class ImageManagementService(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_video_extract_image_endpoint = _Endpoint(
            settings={
                'response_type': (GetVideoExtractImageResponseWrapper,),
                'auth': [],
                'endpoint_path': '/json/sms/service/ImageManagementService/getVideoExtractImage',
                'operation_id': 'get_video_extract_image',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'get_video_extract_image_request_wrapper',
                ],
                'required': [
                    'get_video_extract_image_request_wrapper',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'get_video_extract_image_request_wrapper': 'body',
                },
        ...
        self.upload_image_endpoint = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/json/sms/service/ImageManagementService/uploadImage',
    ...
    def get_video_extract_image(
        self,
        get_video_extract_image_request_wrapper,
        **kwargs
    ):
        """get_video_extract_image  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_video_extract_image(get_video_extract_image_request_wrapper, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['get_video_extract_image_request_wrapper'] = \
            get_video_extract_image_request_wrapper
        return self.get_video_extract_image_endpoint.call_with_http_info(**kwargs)
