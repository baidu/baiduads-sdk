...
class BmcDistributionService(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_catalog_endpoint = _Endpoint(
            settings={
                'response_type': (GetCatalogResponseWrapper,),
                'auth': [],
                'endpoint_path': '/json/sms/service/BmcDistributionService/getCatalog',
            ...
            root_map={
                ...
                'location_map': {
                    'get_catalog_request_wrapper': 'body',
                },
    ...
    def get_catalog(
        ...
        **kwargs
        ...
        >>> thread = api.get_catalog(get_catalog_request_wrapper, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['get_catalog_request_wrapper'] = \
            get_catalog_request_wrapper
