...
class CreativeService(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_creative_template_endpoint = _Endpoint(
            settings={
                'response_type': (GetCreativeTemplateResponseWrapper,),
                'auth': [],
                'endpoint_path': '/json/sms/service/CreativeService/getCreativeTemplate',
                'operation_id': 'get_creative_template',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'get_creative_template_request_wrapper',
                ],
                'required': [
                    'get_creative_template_request_wrapper',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'get_creative_template_request_wrapper': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def get_creative_template(
        ...
        **kwargs
        ...
        >>> thread = api.get_creative_template(get_creative_template_request_wrapper, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['get_creative_template_request_wrapper'] = \
            get_creative_template_request_wrapper
