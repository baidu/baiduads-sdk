...
class VideoUploadService(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_video_endpoint = _Endpoint(
            settings={
                'response_type': (AddVideoResponseWrapper,),
                'auth': [],
                'endpoint_path': '/json/sms/service/VideoUploadService/addVideo',
            ...
            root_map={
                ...
                'location_map': {
                    'add_video_request_wrapper': 'body',
                },
    ...
    def add_video(
        ...
        **kwargs
        ...
        >>> thread = api.add_video(add_video_request_wrapper, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['add_video_request_wrapper'] = \
            add_video_request_wrapper
        return self.add_video_endpoint.call_with_http_info(**kwargs)
